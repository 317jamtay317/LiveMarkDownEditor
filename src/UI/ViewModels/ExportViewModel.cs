...
/// <summary>
/// Export as HTML: renders the Active Session's Markdown Document to its Rendered Output and writes
/// it to a file the user chooses, in the Export Shape they chose alongside it (INV-032).
/// </summary>
/// <remarks>
...
/// <para>
/// It writes through <see cref="IHtmlExportStore"/> and never <see cref="IDocumentStore"/>: an
/// export has no route to the Watched File at all, which is what makes "exporting is not an edit"
...
public sealed class ExportViewModel : ObservableObject
{
    ...
    public ExportViewModel(IFilePicker filePicker, IMarkdownRenderer renderer, IHtmlExportStore exportStore)
    {
